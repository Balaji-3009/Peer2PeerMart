  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://peer2peermart.onrender.com/products/updateProduct?productId=${product.id}`,
        {
          method: "PUT",
          headers: {
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="p-5 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="desc" name="desc" value={formData.desc} onChange={handleChange} rows={3} />
            </div>

            <div className="flex items-center space-x-2 pt-2">
              <input type="checkbox" id="negotiable" name="negotiable" checked={formData.negotiable === 1} onChange={handleChange} />
